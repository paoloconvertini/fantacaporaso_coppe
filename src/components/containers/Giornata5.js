                        ...
                        <tbody>
                            <tr>
                                {<td>
                                    ...
                                    <MagicPunti magic={calGironeA && calGironeA[4].magic[0]} />{' '}-{' '}
                                    <MagicPunti magic={calGironeA && calGironeA[4].magic[1]} />{' '}
                                    <Team squadra={gironeA && gironeA[0].squadra} />{' '}
                                    <Score score={calGironeA && calGironeA[4].risultati[0]} />{' '}-{' '}
                                    <Score score={calGironeA && calGironeA[4].risultati[1]} />
                                </td>}
                            </tr>
                            <tr>
                                {<td>
                                    <Team squadra={gironeA && gironeA[3].squadra} />{' '}
                                    <MagicPunti magic={calGironeA && calGironeA[4].magic[2]} />{' '}-{' '}
                                    <MagicPunti magic={calGironeA && calGironeA[4].magic[3]} />{' '}
                                    <Team squadra={gironeA && gironeA[1].squadra} />{' '}
                                    <Score score={calGironeA && calGironeA[4].risultati[2]} />{' '}-{' '}
                                    <Score score={calGironeA && calGironeA[4].risultati[3]} />
                                </td>}
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            <tr>
                                {<td>
                                    ...
                                    <MagicPunti magic={calGironeB && calGironeB[4].magic[0]} />{' '}-{' '}
                                    <MagicPunti magic={calGironeB && calGironeB[4].magic[1]} />{' '}
                                    <Team squadra={gironeB && gironeB[0].squadra} />{' '}
                                    <Score score={calGironeB && calGironeB[4].risultati[0]} />{' '}-{' '}
                                    <Score score={calGironeB && calGironeB[4].risultati[1]} />
                                </td>}
                            </tr>
                            <tr>
                                {<td>
                                    <Team squadra={gironeB && gironeB[3].squadra} />{' '}
                                    <MagicPunti magic={calGironeB && calGironeB[4].magic[2]} />{' '}-{' '}
                                    <MagicPunti magic={calGironeB && calGironeB[4].magic[3]} />{' '}
                                    <Team squadra={gironeB && gironeB[1].squadra} />{' '}
                                    <Score score={calGironeB && calGironeB[4].risultati[2]} />{' '}-{' '}
                                    <Score score={calGironeB && calGironeB[4].risultati[3]} />
                                </td>}
                            </tr>
                        </tbody>
                    </table>
